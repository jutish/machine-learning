...
#                                    ngram_range=(1,3),
#                                    )
count_X = count_vectorizer.fit_transform(X)
X_train, X_test, y_train, y_test = model_selection.train_test_split(count_X, y, 
...
# Transform our validation data using our CountVectorizer instance.
validation_data = pd.read_csv('./data/validation_data.csv')
less_toxic_count = count_vectorizer.transform(validation_data.less_toxic)
more_toxic_count = count_vectorizer.transform(validation_data.more_toxic)
